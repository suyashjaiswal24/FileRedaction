...
const ACCEPTED = '.pdf,.txt,.docx,.doc,.docm,.odt,.rtf,.xlsx,.xls,.ods,.pptx,.ppt,.odp,.png,.jpg,.jpeg,.tiff,.tif,.bmp,.gif,.webp'
const ACCEPTED_LABEL = 'PDF, TXT, Word, Excel, PowerPoint, Images'
